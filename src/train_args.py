...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_data', default='img')
    ...
    parser.add_argument('--save_model_path', default='../model/resnet18_img_mstar_')
    parser.add_argument('--transfer', type=int, default=1)
    parser.add_argument('--transfer_layers', type=int, default=5)
    parser.add_argument('--pretrained_model_path', default='../model/resnet18_I_nwpu_cate45_tsx_level1_cate7_col36_imb_ce+topk+.pth')
